...
from modeling.modeling_vqa_x_chunkalign_v10 import ChunkAlign_CLS_dec5_4, SeqBertImgModel
...
def main():
    ...
    model = ChunkAlign_CLS_dec5_4(oscar_model, seq_model, gpt_model, gpt_tokenizer, num_labels=len(id2label))
    # 加载预训练encoder
