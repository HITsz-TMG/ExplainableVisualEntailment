...
from modeling.modeling_sequence_align_encoder1 import ChunkAlign_dec5_4, SeqBertImgModel
...
def main():
    ...
    model = ChunkAlign_dec5_4(oscar_model, gpt_model, seq_model, gpt_tokenizer, args.beam_size,
