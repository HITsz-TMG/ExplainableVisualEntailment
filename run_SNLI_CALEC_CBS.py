...
from oscar.modeling.modeling_transfomres import GPT2Model, BertImgModel
from oscar.modeling.modeling_snli_con_copy import ChunkAlign_dec5_4_con_copy_mask_5, SeqBertImgModel
from transformers import BertTokenizerFast, BertConfig

from oscar.Data.SNLISeqAlign import SNLISeqAlignChunkDataset_v7_prompt
...
def main():
    ...
    parser.add_argument("--eval_model_dir", type=str,
                        default='./Oscar/oscar/output/SNLI_dec5_4_con_copy_mask_5_1/checkpoint-0-28000-score0.2927-nlg_score-0.3585-acc-0.8164-blue-0.1027-meteor-0.1993-rouge-0.2830-cider_exp-0.8670-spice-0.3404-/',
    ...
    model = ChunkAlign_dec5_4_con_copy_mask_5(oscar_model, gpt_model, seq_model, tokenizer, gpt_tokenizer,
                                              args.beam_size,
