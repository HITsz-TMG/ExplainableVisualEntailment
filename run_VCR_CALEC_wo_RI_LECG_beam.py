...
from modeling.modeling_vcr_chunkalign_v10 import ChunkAlign_CLS_dec5_4_wo_reasoning_beam, SeqBertImgModel
...
def main():
    ...
    parser.add_argument("--eval_model_dir", type=str,
                        default='./Oscar/oscar/output/VCR_dec5_4_wo_reasoning/checkpoint-19-57000-score0.1450-nlg_score-0.1993-acc-0.7274-blue-0.2177-meteor-0.1826-rouge-0.2329-spice-0.0000-/',
    ...
    model = ChunkAlign_CLS_dec5_4_wo_reasoning_beam(oscar_model, seq_model, gpt_model, tokenizer, gpt_tokenizer, num_labels=4,
