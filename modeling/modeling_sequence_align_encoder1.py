...
class ChunkAlign_CLS_enc4(nn.Module):
    ...
    def save_heat(self, input_ids, img_feat, expl_ids=None, input_mask=None, label=None, attn_mask=None,
                  token_type_ids=None, position_ids=None, head_mask=None, encoder_history_states=None,
                  offsets=None, chunk_attention_mask=None, syn_labels_ids=None, gather_index=None):
        hypo_len = input_ids.size(1)
...
class ChunkAlign_dec5_4(nn.Module):
    ...
    def forward(self, input_ids, img_feat, expl_ids, input_mask=None, label=None, attn_mask=None,
                token_type_ids=None, position_ids=None, head_mask=None, encoder_history_states=None,
                offsets=None, chunk_attention_mask=None, gpt_labels=None, gather_index=None):
        hypo_len = input_ids.size(1)
...
class ChunkAlign_dec5_4_wo_chual(nn.Module):
    def __init__(self, global_enc, dec, dec_toker, beam_size, max_hypo):
        super(ChunkAlign_dec5_4_wo_chual, self).__init__()
        self.global_enc = global_enc
        self.dec_toker = dec_toker
        self.dec = dec
    ...
    def forward(self, input_ids, img_feat, expl_ids, input_mask=None, label=None, attn_mask=None,
        ...
        word_mask = (1.0 - word_mask) * -10000.0
        for i, layer_module in enumerate(self.cls_layer):
            CLS_ensem, attention_layer = layer_module(self_chunk_align, CLS_ensem, word_mask)
...
class ChunkAlign_dec5_4_wo_reasoning(nn.Module):
    def __init__(self, global_enc, dec, seq_enc, dec_toker, beam_size, max_hypo):
        super(ChunkAlign_dec5_4_wo_reasoning, self).__init__()
        self.global_enc = global_enc
        self.seq_enc = seq_enc
        self.dec_toker = dec_toker
        self.dec = dec
...
class ChunkAlign_dec5_4_gen_constrain(nn.Module):
    def __init__(self, global_enc, dec, seq_enc, enc_toker, dec_toker, beam_size, repeat_penalty, length_penalty,
                 constrained, stop_words_index):
        super(ChunkAlign_dec5_4_gen_constrain, self).__init__()
        self.global_enc = global_enc
        self.seq_enc = seq_enc
        ...
        self.stop_words = ['a', 'is', 'am', 'are', 'the', 'an', 'it', 'has', 'very', 'and', 'his', 'her', 'there',
                           ...
                           'have', 'them', 'him', 'than', 'not', 'person']  # 1

    def test_beam(self, input_ids, img_feat, expl_ids, input_mask=None, label=None, attn_mask=None,
                  token_type_ids=None, position_ids=None, head_mask=None, encoder_history_states=None,
...
class ChunkAlign_dec5_4_wo_chual_constrain(nn.Module):
    def __init__(self, global_enc, dec, enc_toker, dec_toker, beam_size, repeat_penalty, length_penalty,
                 constrained, stop_words_index):
        super(ChunkAlign_dec5_4_wo_chual_constrain, self).__init__()
        self.global_enc = global_enc
...
class ChunkAlign_dec5_4_wo_reasoning_constrain(nn.Module):
    def __init__(self, global_enc, dec, seq_enc, enc_toker, dec_toker, beam_size, repeat_penalty, length_penalty,
                 constrained):
        super(ChunkAlign_dec5_4_wo_reasoning_constrain, self).__init__()
        self.global_enc = global_enc
        self.seq_enc = seq_enc
        self.enc_toekr = enc_toker
        self.dec_toker = dec_toker
...
class ChunkAlign_dec5_4_wo_chual_reasoning_constrain(nn.Module):
    def __init__(self, global_enc, dec, enc_toker, dec_toker, beam_size, repeat_penalty, length_penalty,
                 constrained, stop_words_index):
        super(ChunkAlign_dec5_4_wo_chual_reasoning_constrain, self).__init__()
