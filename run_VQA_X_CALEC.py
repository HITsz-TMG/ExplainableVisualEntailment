    ...
    for epoch in range(int(args.num_train_epochs)):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            inputs = {'input_ids': batch['input_ids'], 'token_type_ids': batch['token_type_ids'],
                      ...
                      'gather_index': batch['gather_index'], 'gpt_labels': batch['gpt_labels'],
...
def main():
    ...
    parser.add_argument("--enc_pretrain_model_dir", type=str,
                        default='./Oscar/oscar/output/VQA_X_enc4/checkpoint-24-2800-acc-0.8609/',
                        help="Model directory for evaluation.")
    parser.add_argument("--output_dir", default='./output/VQA_X_ChunkAlign_dec5_4_con_copy_mask_5', type=str,
                        required=False,
