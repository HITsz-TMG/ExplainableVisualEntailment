...
from modeling.modeling_vcr_chunkalign_v10 import ChunkAlign_CLS_enc4_align_wo_reasoning, SeqBertImgModel
...
def main():
    ...
    parser.add_argument("--output_dir", default='./output/VCR_ChunkAlign_enc1_4_wo_reasoning', type=str, required=False,
    ...
    model = ChunkAlign_CLS_enc4_align_wo_reasoning(oscar_model, seq_model, num_labels=4)
    if args.do_test:
        model_file = os.path.join(args.eval_model_dir, 'model.pth')
        model.load_state_dict(torch.load(model_file))
