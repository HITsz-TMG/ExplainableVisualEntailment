...
from modeling.modeling_sequence_align import BaseLine_cls
from transformers import BertTokenizerFast, BertConfig
from transformers import AdamW, get_linear_schedule_with_warmup, get_constant_schedule_with_warmup

from Data.SNLISeqAlign import SNLISeqAlignChunkDataset_v7, SNLISeqBaseDatasets
    ...
    for epoch in range(int(args.num_train_epochs)):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            inputs = {'input_ids': batch['input_ids'], 'token_type_ids': batch['token_type_ids'],
                      ...
                      'syn_labels_ids': batch['syn_labels_ids']}
...
def main():
    ...
    parser.add_argument("--output_dir", default='./output/SNLI_baseline_CLS', type=str, required=False,
    ...
    # for generation
    parser.add_argument("--eval_model_dir", type=str, default='./Oscar/oscar/output/SNLI_baseline_CLS/checkpoint-6-10000-acc-0.8141/',
    ...
    model = BaseLine_cls(oscar_model, args.beam_size, max_hypo=args.max_hypo_len)
    if args.do_test:
        model_file = os.path.join(args.eval_model_dir, 'model.pth')
        model.load_state_dict(torch.load(model_file))
    ...
    if args.do_train:
        ...
        # 保存热力图
        test_dataset = SNLISeqBaseDatasets(tokenizer, gpt_tokenizer, args.SNLI_example_file_test,
                                           args.flickr_feat_file_test,
                                           args.SNLI_chunk_mask_test,
                                           max_hypo_len=args.max_hypo_len, max_seq_length=args.max_seq_length,
