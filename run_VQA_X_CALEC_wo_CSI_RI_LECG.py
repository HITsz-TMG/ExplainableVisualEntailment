...
from modeling.modeling_vqa_x_chunkalign_v10 import Base_freeze
...
def main():
    ...
    parser.add_argument("--enc_pretrain_model_dir", type=str,
                        default='./Oscar/oscar/output/VQA_X_BaseLine_cls_xe/checkpoint-27-3150-acc-0.8239/',
                        help="Model directory for evaluation.")
    parser.add_argument("--output_dir", default='./output/VQA_X_base_freeze', type=str, required=False,
    ...
    model = Base_freeze(oscar_model, gpt_model, gpt_tokenizer, num_labels=len(id2label))
    # 加载预训练encoder
