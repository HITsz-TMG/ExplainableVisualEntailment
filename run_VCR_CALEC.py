...
from modeling.modeling_vcr_con_copy import ChunkAlign_CLS_dec5_4_copy_mask_5, SeqBertImgModel
...
def main():
    ...
    parser.add_argument("--output_dir", default='./output/VCR_dec5_4_copy_mask_5', type=str, required=False,
    ...
    parser.add_argument("--enc_pretrain_model_dir", type=str,
                        default='./Oscar/oscar/output/VCR_ChunkAlign_enc1_4_align_loss/checkpoint-8-26000-acc-0.7304/',
                        help="Model directory for evaluation.")
    ...
    model = ChunkAlign_CLS_dec5_4_copy_mask_5(oscar_model, seq_model, gpt_model, tokenizer, gpt_tokenizer, num_labels=4)
    # 加载预训练encoder
    ...
    if args.do_train:
        ...
        workbook.save(os.path.join(args.eval_model_dir, file_name))
        nlg_score = (score['ROUGE_L'][0] + score['METEOR'][0] + score['CIDEr'][0] + score['SPICE'][0]) / 4
