...
from modeling.modeling_vqa_x_chunkalign_v10 import ChunkAlign_CLS_dec5_4_wo_chual_reasoning, SeqBertImgModel
...
def main():
    ...
    parser.add_argument("--eval_model_dir", type=str,
                        default='./Oscar/oscar/output/VQA_X_base_freeze/checkpoint-29-3350-score0.2863-nlg_score-0.3475-acc-0.8239-blue-0.5600-meteor-0.2030-rouge-0.4294-spice-0.1729-/',
                        help="Model directory for evaluation.")
    ...
    model = ChunkAlign_CLS_dec5_4_wo_chual_reasoning(oscar_model, gpt_model, tokenizer, gpt_tokenizer,
