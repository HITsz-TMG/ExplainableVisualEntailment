...
from modeling.modeling_vqa_x_chunkalign_v10 import ChunkAlign_CLS_dec5_4_gen, SeqBertImgModel
...
def main():
    ...
    parser.add_argument("--eval_model_dir", type=str,
                        default='./Oscar/oscar/output/VQA_X_ChunkAlign_dec5_4/checkpoint-28-3250-score0.3386-nlg_score-0.3933-acc-0.8609-blue-0.5864-meteor-0.2198-rouge-0.4536-spice-0.1991-/',
                        help="Model directory for evaluation.")
    ...
    model = ChunkAlign_CLS_dec5_4_gen(oscar_model, seq_model, gpt_model, tokenizer, gpt_tokenizer,
