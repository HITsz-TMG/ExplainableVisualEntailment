...
from oscar.modeling.modeling_transfomres import BertImgModel
from oscar.modeling.modeling_sequence_align_pretrain_2_align_only import SeqAlign_pretrain_v2_align_only, \
    SeqBertImgModel
from transformers import BertTokenizerFast, BertConfig
from transformers import AdamW, get_linear_schedule_with_warmup, get_constant_schedule_with_warmup
from oscar.Data.SNLI_SeqAlign import SeqAlignPretrainDataset_v2_align_only
from oscar.progressbar import ProgressBar
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            if (step + 1) % args.gradient_accumulation_steps == 0:
                ...
                pbar(step=new_step % pbar_len,
                     info={'Epoch': epoch, 'loss': global_loss / new_step, 'align_loss': global_align_loss / new_step})
...
def main():
    ...
    parser.add_argument("--SNLI_example_file_train",
                        default="./e-ViL-main/AlignLabelTrain_example.pkl", type=str)
    parser.add_argument("--SNLI_example_file_dev",
                        default="./e-ViL-main/AlignLabelDev_example.pkl", type=str)
    parser.add_argument("--SNLI_example_file_test",
                        default="./e-ViL-main/AlignLabelTest_example.pkl",
                        type=str)
    parser.add_argument("--SNLI_image_feat_train",
                        default="./e-ViL-main/AlignLabelTrain_imagefeat.pkl", type=str)
    parser.add_argument("--SNLI_image_feat_dev",
                        default="./e-ViL-main/AlignLabelDev_imagefeat.pkl", type=str)
    parser.add_argument("--SNLI_image_feat_test",
                        default="./e-ViL-main/AlignLabelTest_imagefeat.pkl",
                        type=str)
    ...
    parser.add_argument("--output_dir", default='./output/SeqAlign_pretrain_v2_align_only', type=str, required=False,
    ...
    parser.add_argument('--save_steps', type=int, default=320,
    ...
    parser.add_argument("--valid_steps", default=320, type=int,
    ...
    model = SeqAlign_pretrain_v2_align_only(seq_model, seq_config)
    if args.do_test:
        model_file = os.path.join(args.eval_model_dir, 'model.pth')
        model.load_state_dict(torch.load(model_file))
    ...
    if args.do_train:
        train_dataset = SeqAlignPretrainDataset_v2_align_only(tokenizer, args.SNLI_example_file_train,
                                                              args.SNLI_image_feat_train)
        train_dataloader = build_dataloader(train_dataset, True, args)
        val_dataset = SeqAlignPretrainDataset_v2_align_only(tokenizer, args.SNLI_example_file_dev,
                                                            args.SNLI_image_feat_dev)
    ...
    # inference and evaluation
        ...
        test_dataset = SeqAlignPretrainDataset_v2_align_only(tokenizer, args.SNLI_example_file_test,
                                                             args.SNLI_image_feat_test)
