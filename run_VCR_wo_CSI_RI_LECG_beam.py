...
from modeling.modeling_vcr_chunkalign_v10 import ChunkAlign_CLS_dec5_4_wo_chual_reasoning_beam
...
def main():
    ...
    parser.add_argument("--eval_model_dir", type=str,
                        default='./Oscar/oscar/output/VCR_BaseLine_freeze/checkpoint-18-55000-score0.1352-nlg_score-0.1858-acc-0.7275-blue-0.1815-meteor-0.1010-rouge-0.2013-spice-0.1271-/',
    ...
    model = ChunkAlign_CLS_dec5_4_wo_chual_reasoning_beam(oscar_model, gpt_model, tokenizer, gpt_tokenizer,
                                                          num_labels=4,
