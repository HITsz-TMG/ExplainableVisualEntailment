...
from modeling.modeling_sequence_align_encoder1 import ChunkAlign_CLS_enc4, SeqBertImgModel
...
def main():
    ...
    parser.add_argument("--seq_model_name_or_path",
                        ...
                        type=str, required=False,
                        help="Path to pre-trained model or model type.")
    parser.add_argument("--output_dir", default='./output/SNLI_ChunkAlign_CLS_enc4', type=str, required=False,
    ...
    # for generation
    parser.add_argument("--eval_model_dir", type=str, default='./Oscar/oscar/output/SNLI_ChunkAlign_CLS_enc4/checkpoint-6-2625-acc-0.8164/',
    ...
    model = ChunkAlign_CLS_enc4(oscar_model, seq_model)
