...
from modeling.modeling_sequence_align import BaseLine_freeze
...
def main():
    ...
    parser.add_argument("--output_dir", default='./output/SNLI_base_freeze', type=str, required=False,
    ...
    parser.add_argument("--enc_pretrain_model_dir", type=str,
                        default='./Oscar/oscar/output/SNLI_baseline_CLS/checkpoint-6-10000-acc-0.8141/',
                        help="Model directory for evaluation.")
    ...
    model = BaseLine_freeze(oscar_model, gpt_model, gpt_tokenizer, args.beam_size,
