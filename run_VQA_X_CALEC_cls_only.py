...
from modeling.modeling_vqa_x_chunkalign_v10 import ChunkAlign_CLS_enc4, SeqBertImgModel
...
def main():
    ...
    parser.add_argument("--output_dir", default='./output/VQA_X_enc4', type=str, required=False,
    ...
    model = ChunkAlign_CLS_enc4(oscar_model, seq_model, num_labels=len(id2label))
    if args.do_test:
        model_file = os.path.join(args.eval_model_dir, 'model.pth')
        model.load_state_dict(torch.load(model_file))
