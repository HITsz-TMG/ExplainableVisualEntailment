...
from modeling.modeling_vqa_x_chunkalign_v10 import ChunkAlign_CLS_dec5_4_wo_reasoning_test_beam, SeqBertImgModel
...
def main():
    ...
    parser.add_argument("--enc_pretrain_model_dir", type=str,
                        default='./oscar/output/VQA_X_ChunkAlign_enc4/checkpoint-28-3250-acc-0.8568/',
                        help="Model directory for evaluation.")
    ...
    parser.add_argument("--eval_model_dir", type=str,
                        default='./oscar/output/VQA_X_ChunkAlign_dec5_4_wo_reasoning/checkpoint-15-4050-score0.3132-nlg_score-0.3760-acc-0.8328-blue-0.5724-meteor-0.2131-rouge-0.4455-spice-0.1896-/',
                        help="Model directory for evaluation.")
    ...
    model = ChunkAlign_CLS_dec5_4_wo_reasoning_test_beam(oscar_model, seq_model, gpt_model, tokenizer, gpt_tokenizer,
