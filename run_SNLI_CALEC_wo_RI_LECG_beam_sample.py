...
from modeling.modeling_sequence_align_encoder1 import ChunkAlign_dec5_4_wo_reasoning_constrain, SeqBertImgModel
...
def main():
    ...
    parser.add_argument("--seq_model_name_or_path",
                        ...
                        type=str, required=False,
                        help="Path to pre-trained model or model type.")
    parser.add_argument("--output_dir", default='./output/SNLI_ChunkAlign_dec5_4_wo_reasoning', type=str, required=False,
    ...
    parser.add_argument("--eval_model_dir", type=str,
                        default='./Oscar/oscar/output/SNLI_CAS_wo_reasoning_dec5_4/checkpoint-11-35000-score0.3521-nlg_score-0.4323-acc-0.8144-blue-0.3236-meteor-0.1909-rouge-0.3012-spice-0.3314-/',
    ...
    model = ChunkAlign_dec5_4_wo_reasoning_constrain(oscar_model, gpt_model, seq_model, tokenizer, gpt_tokenizer, args.beam_size,
                                            args.repeat_penalty,
                                            length_penalty=args.length_penalty, constrained=1.0)
